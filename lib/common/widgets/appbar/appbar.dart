...
class CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: SpacingStyle.paddingWithDefaultWidth,
      child: AppBar(
            ...
            showBackArrow
                ? IconButton(
                  ...
                  icon: Icon(
                    ...
                    color: dark ? CommonColors.white : CommonColors.dark,
                  ),
                )
                : leadingIcon != null
                ? IconButton(
            ...
            showSkipButton
                ? [
                  OutlinedButton(
                    ...
                    child: const Text(CommonTexts.skip),
                  ),
                ]
                : showActions
                ? (actions != null)
                      ...
                      showActionWithBadge
                          ? badges.Badge(
                            ...
                            badgeStyle: const badges.BadgeStyle(
                              badgeColor: CommonColors.primary,
                            ),
                          ...
                          : IconButton(
                            ...
                            icon: Icon(
                              actionIcon,
                              color:
                                  dark ? CommonColors.white : CommonColors.dark,
                            ),
                          ),
                    ]
                : null,
