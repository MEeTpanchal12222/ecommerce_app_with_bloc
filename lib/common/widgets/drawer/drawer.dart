      ...
      child: Column(
        ...
        children: [
          InkWell(
            ...
            child: Container(
              color: CommonColors.textDarkSecondary,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: Theme.of(
                      context,
                    ).textTheme.bodyMedium!.apply(color: CommonColors.dark),
                  ),
                ],
              ),
            ),
  ...
  List<Widget> _drawerItems() {
    return [
      ...
      _buildDrawerItem(
        ...
        onTap: () => Get.toNamed(Routes.eComDashboard),
      ),
      _buildDrawerItem(
      ...
      _buildDrawerItem(
        ...
        title: "Checkout",
        onTap: () => Get.toNamed(Routes.checkoutScreen),
      ),
      _buildDrawerItem(
        icon: Iconsax.heart,
        title: "Wishlist",
