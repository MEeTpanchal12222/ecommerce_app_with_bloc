...
class NotificationDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    controller.selectedNotification.value =
        Get.arguments ?? NotificationModel.empty();
    ...
    return Scaffold(
      appBar: CustomAppBar(
        ...
        showActions: false,
        showBackArrow: true,
        leadingOnPressed: () => Get.offNamed(Routes.notification),
      ),
      body: Padding(
              ...
              children: [
                if (controller.selectedNotification.value.type.isNotEmpty)
                  TRoundedContainer(
                    ...
                    child: Text(
                      controller.selectedNotification.value.type,
                      style: Theme.of(
                        context,
                    ...
                    child: ElevatedButton.icon(
                      onPressed:
                          () => Get.toNamed(
                            ...
                            parameters: {
                              'id':
                                  controller.selectedNotification.value.routeId,
                            },
                          ),
