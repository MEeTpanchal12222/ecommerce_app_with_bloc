...
class WelcomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        backgroundColor:
            isDarkMode ? CommonColors.secondary : CommonColors.primary,
        body: Stack(
          children: [
            FadeInAnimation(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          Text(
                            CommonTexts.tWelcomeTitle,
                            style: Theme.of(context).textTheme.displayMedium,
                          ),
                          const SizedBox(height: TSizes.sm),
                          Text(
                            CommonTexts.tWelcomeSubTitle,
                        ...
                        children: [
                          Expanded(
                            child: OutlinedButton(
                              ...
                              child: Text(CommonTexts.tLogin.toUpperCase()),
                            ),
                          ),
                          ...
                          Expanded(
                            child: ElevatedButton(
                              ...
                              child: Text(CommonTexts.tSignup.toUpperCase()),
                            ),
                          ),
                        ],
                      ),
