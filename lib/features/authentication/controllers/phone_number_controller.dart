...
class SignInController extends GetxController {
  ...
  Future<void> loginWithPhoneNumber() async {
    try {
      ...
      if (selectedCountryCode.value.isEmpty) {
        TLoaders.customToast(message: CommonTexts.selectCountryCode);
        return;
      }
      ...
      if (otpVerified) {
        ...
        TLoaders.successSnackBar(
          title: CommonTexts.phoneVerifiedTitle,
          message: CommonTexts.phoneVerifiedMessage,
        );
  ...
  Future<bool> _checkInternetConnectivity() async {
    ...
    if (!isConnected) {
      ...
      TLoaders.errorSnackBar(
        title: CommonTexts.noInternet.tr,
        message: CommonTexts.checkInternetConnection.tr,
      );
      return false;
    }
    return true;
  ...
  void _handleException(Object e) {
    ...
    TFullScreenLoader.stopLoading();
    TLoaders.errorSnackBar(title: CommonTexts.ohSnap, message: e.toString());
  }
