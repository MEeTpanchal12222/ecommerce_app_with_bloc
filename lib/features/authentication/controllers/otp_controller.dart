...
class OTPController extends GetxController {
  ...
  void startTimer() {
    try {
      ...
      TLoaders.errorSnackBar(title: CommonTexts.ohSnap.tr, message: e.toString());
    }
  }
  ...
  Future<void> resendOTP() async {
    try {
      ...
      TLoaders.successSnackBar(title: CommonTexts.otpSendTitle.tr, message: CommonTexts.otpSendMessage.tr);

      startTimer(); // Restart the timer
    } catch (e) {
      TLoaders.errorSnackBar(title: CommonTexts.unableToSendOTP.tr, message: e.toString());
    }
  }
  ...
  Future<void> verifyOTP() async {
    try {
      ...
      TFullScreenLoader.stopLoading();
      TLoaders.warningSnackBar(title: CommonTexts.ohSnap, message: e.toString());
    }
  }
}
