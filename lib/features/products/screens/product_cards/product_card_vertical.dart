    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: dark ? CommonColors.darkerGrey : CommonColors.white,
        ),
        child: Column(
                  ...
                  if (salePercentage != null)
                    Positioned(
                      ...
                      child: TRoundedContainer(
                        radius: TSizes.sm,
                        backgroundColor: CommonColors.primary.withValues(
                          alpha: 0.8,
                        ),
                      ...
                      decoration: BoxDecoration(
                        color:
                            productQuantityInCart > 0
                                ? CommonColors.dashboardAppbarBackground
                                : CommonColors.dark,
                              ...
                              productQuantityInCart > 0
                                  ? Text(
                                    ...
                                    style: Theme.of(context)
                                        .textTheme
                                        .bodyLarge!
                                        .apply(color: CommonColors.white),
                                  )
                                  : const Icon(
                                    Iconsax.add,
