...
class TProductQuantityWithAddRemoveButton extends StatelessWidget {
  const TProductQuantityWithAddRemoveButton({
    ...
    this.addBackgroundColor = CommonColors.black,
    this.removeBackgroundColor = CommonColors.darkGrey,
    this.addForegroundColor = CommonColors.white,
    this.removeForegroundColor = CommonColors.white,
  });
